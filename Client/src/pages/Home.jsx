...
function Home() {
  return (
    <div className="bg-[#0F0E1B] w-full relative overflow-hidden px-6 py-2 ">
      <NavbarHome />
      <div className="bg-gradient-to-br from-[#D6D446] via-[#E6E46A] to-[#03C7BD] w-[500px] h-[700px] rounded-full blur-[600px] absolute top-[-450px] left-[-350px] "></div>
      <div className="bg-gradient-to-tr from-[#D6D446] via-[#03C7BD] to-[#03C7BD] w-[500px] h-[700px] rounded-full blur-[600px] absolute top-[-650px] right-[-400px] "></div>
      ...
      <div className="w-full min-h-screen flex items-center justify-center ">
        <div className="flex flex-col items-center gap-6 w-full px-2 sm:px-4">
          <div className="flex flex-col items-center gap-2 w-full">
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-semibold bg-gradient-to-b from-[#FFFFFF] to-[#100E0E] bg-clip-text text-transparent pb-2 sm:pb-3 md:pb-4 text-center">
              Best SaaS Company in the town
            </h2>
          </div>
          <p className="w-full max-w-xl md:max-w-2xl text-center text-base sm:text-lg md:text-2xl text-[#989FAB] px-2">
            Our products seek to help you and your business in every possible
            way. We help you run your enterprise smoothly.
          </p>
          <div className="flex flex-col sm:flex-row items-center gap-4 text-white text-base sm:text-lg md:text-[20px] mt-3 w-full justify-center">
            <Link
              to="/register"
              className="bg-[#303A96] px-8 sm:px-10 md:px-13 py-3 sm:py-4 rounded text-center w-full sm:w-auto"
            >
              Register Now
            </Link>
            <a
      ...
      >
        <div className="w-full flex flex-col md:flex-row items-stretch md:items-start gap-6 md:gap-0">
          ...
          <div className="md:w-[28%] w-full p-6 flex flex-col gap-4">
            <h4 className="text-2xl sm:text-[28px] text-white">
              Services we provide
            </h4>
            <p className="max-w-full md:max-w-[60%] text-base sm:text-[16px] text-[#989FAB]">
              We are redefining the way the business owners run their
              enterprise.
            </p>
          </div>
          {/* Service 1 */}
          <div className="md:w-[24%] w-full p-6 flex flex-col gap-4 items-start bg-[#374151]">
            ...
            <p className="text-base sm:text-[16px] text-[#989FAB]">
              We help you store, unify and organise your business data in the
              most optimised way possible.
            </p>
          </div>
          {/* Service 2 */}
          <div className="md:w-[24%] w-full p-6 flex flex-col gap-4 items-start">
            <div className="w-14 h-14 sm:w-16 sm:h-16 bg-[#1F2937] rounded-full flex items-center justify-center">
            ...
            <p className="text-base sm:text-[16px] text-[#989FAB]">
              Register customers on the go, download receipt and send them to
              your customers, all under one platform. Save paper, be
              sustainable!
            </p>
          </div>
          {/* Service 3 */}
          <div className="md:w-[24%] w-full p-6 flex flex-col gap-4 items-start">
            ...
            <p className="text-base sm:text-[16px] text-[#989FAB]">
              As a business owner you deserve to have a clear visibility of your
        ...
        <div className="relative w-full flex flex-col lg:flex-row justify-center items-center gap-6">
          ...
          <div className="w-full sm:w-[90%] lg:w-[320px] max-w-[370px] h-auto bg-[#232a36] rounded-xl shadow-lg transition-all duration-300 lg:mr-6 lg:ml-0 ml-0 mb-6 lg:mb-0 flex-shrink-0">
            <div className="flex flex-col items-center justify-center px-8 py-10 h-full">
              <h3 className="text-white text-2xl font-semibold mb-2">Basic</h3>
        ...
        <form className="w-full md:w-[65%] bg-[#232a36] rounded-xl shadow-lg p-6 flex flex-col gap-4">
          <div className="flex flex-col sm:flex-row gap-4">
            <div className="flex-1 flex flex-col">
              <label htmlFor="contact-name" className="text-white mb-1 text-sm">
                Name
              </label>
              <input
                id="contact-name"
          ...
          <div className="flex flex-col">
            <label htmlFor="contact-phone" className="text-white mb-1 text-sm">
              Phone
            </label>
            <input
              id="contact-phone"
