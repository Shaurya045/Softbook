  ...
  return (
    <>
      {showPDf ? (
        ...
        <div className="bg-white w-[80%] px-[40px] rounded-[10px] flex flex-col gap-[35px] py-[40px] shadow-lg ">
          <h1 className="text-center text-2xl font-semibold  ">
            Fill the Form With the New Admission
          </h1>

          <form className="flex flex-col gap-[25px]" onSubmit={onSubmitHandler}>
            ...
            <div className="flex gap-[40px]">
              ...
              <div className="flex flex-col gap-1 w-full">
                <p className="text-[16px] font-semibold pl-[3px] ">Seat No.</p>
                <input
                  value={data.seat}
                  onChange={onChangeHandler}
                  name="seat"
            ...
            <div className="flex gap-[40px]">
              <div className="flex flex-col gap-1 w-full">
                <p className="text-[16px] font-semibold pl-[3px] ">ID Proof</p>
                <select
                  onChange={onChangeHandler}
                  className=" outline-none p-2 border-2 border-gray-300 rounded-[10px] "
                  name="idProof"
